...
#include <Arduino.h>
#include <WiFi.h>
#include <AsyncTCP.h>           // by ESP32Async versão 3.4.4
#include <ESPAsyncWebServer.h>  // by ESP32Async Versão 3.7.8
...
char* ssid = ("NRC-AP_Ext"); // Your WiFi AP SSID 
char* password = ("Nevil-RC"); // Your WiFi Password
