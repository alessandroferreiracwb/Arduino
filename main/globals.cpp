...
// backButtonMqttConfig será reposicionado em screens.cpp
Button backButtonMqttConfig = {
  .x = 10, // Placeholder
  .y = 5,  // Placeholder
  .width = 60,
  .height = 40, // Altura ajustada para combinar com outros botões de voltar
  .text = "<-",
  .color = TFT_RED,
  .textColor = TFT_WHITE,
  .textSize = FONT_SIZE
...
// Arrays com caracteres para cada modo de teclado (NOVO LAYOUT)
